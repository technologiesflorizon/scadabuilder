...
| --- | --- | --- | --- |
| 2026-08-24 | `V2.1.5.0034` | `PENDING` | Couverture Task 3.5 : frontiere presse-papier dans les deux sens, duplication, composant de bibliotheque, decision operateur et absence de reference orpheline. |
