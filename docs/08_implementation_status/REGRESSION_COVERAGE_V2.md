...
| --- | --- | --- | --- |
| 2026-07-16 | `V2.1.4.0062` | `PENDING` | Carte synchronisee avec les gates exact-SHA, parite, rollback et acceptance industrielle sans ecriture PLC. |
