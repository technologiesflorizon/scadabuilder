...
3. Hover group border, advanced popup lifecycle policy, named popup host regions, popup sizing presets, degraded semantics, compound conditions, SCADA Builder-side visual effects, and global lifecycle scripts remain roadmap unless tests prove otherwise.
