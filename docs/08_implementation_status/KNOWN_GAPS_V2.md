...
| --- | --- | --- | --- |
| 2026-08-25 | `V2.1.5.0043` | `PENDING` | Requalification du blocage Phase 5 : Django s'execute sous WSL; restent un serveur MySQL local et six echecs preexistants de `tests_scada_package`. |
