...
| --- | --- | --- | --- |
| 2026-08-23 | `V2.1.5.0030` | `PENDING` | Task 3.4 QuickWindow fermee cote editeur; l'apercu reste editor-only et aucune capacite runtime n'est promue. Le presse-papier inter-contextes (Task 3.5) et la surface de reparation `FR-UI-24` (Task 3.6) restent ouverts. |
