...
5. Expression binding, degraded tag semantics, runtime read-response application, and SCADA Builder-side tag creation remain roadmap. Local tag creation depends on a future project protocol import revision.
