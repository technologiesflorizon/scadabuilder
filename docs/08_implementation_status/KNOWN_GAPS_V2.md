...
3. Advanced popup lifecycle policy, named popup host regions, popup sizing presets, degraded semantics, compound conditions, custom visual effects, and global lifecycle scripts remain roadmap unless tests prove otherwise.
