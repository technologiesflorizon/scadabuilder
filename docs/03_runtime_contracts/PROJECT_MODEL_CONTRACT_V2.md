...
| --- | --- | --- | --- |
| 2026-09-08 | `V2.1.6.0013` | `PENDING` | Les trois modules (projet, scène, catalogue) portent les champs `FormatVersion` et `EffectiveFormatVersion`. Jamais sérialisés tant que nuls, donc les artefacts figés demeurent byte-identiques. |
