...
17. `MountFragment` actions open compiled `Fragment` pages in a page-local popup iframe. The runtime emits `scada-builder-popup-opened` and `scada-builder-popup-closed` diagnostics.
