...
| --- | --- | --- | --- |
| 2026-07-14 | `V2.1.4.0016` | `PENDING` | Le Tableau Element+ est exporte dans le HTML/CSS de page du contrat `.sb2` existant; les inputs cellule restent locaux et les artefacts editeur sont exclus. |
