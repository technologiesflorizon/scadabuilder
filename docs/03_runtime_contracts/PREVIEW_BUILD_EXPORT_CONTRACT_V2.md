...
| --- | --- | --- | --- |
| 2026-08-24 | `V2.1.5.0037` | `PENDING` | Task 4.0 : projection build/export des Fenêtres rapides documentée, artefacts editor-only exclus et gate fail-closed rappelé. |
