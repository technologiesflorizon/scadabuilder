...
| --- | --- | --- | --- |
| 2026-07-17 | `V2.1.4.0064` | `PENDING` | `win00012_modern_no_legacy` ajoute les rangees Depart Manuel et Etat du degivrage, avec 14 boutons et 14 voyants rectangulaires sans mapping. |
