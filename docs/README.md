...
| --- | --- | --- | --- |
| 2026-09-08 | `V2.1.6.0010` | `PENDING` | Pre-spec des icones interactives : decisions arretees, propositions non confirmees et points non tranches separes. C5 du chantier C ramenee a convertir ou ne pas ouvrir. |
