...
| --- | --- | --- | --- |
| 2026-08-25 | `V2.1.5.0045` | `PENDING` | Task 5.1 : TF100Web ingere et refuse fail-closed les registres Fenetre rapide du manifest 2.3 avant activation et deploiement. |
