...
| --- | --- | --- | --- |
| 2026-08-23 | `V2.1.5.0030` | `PENDING` | Task 3.4 Fenetres rapides livree : module runtime hote adapte du prototype gele, apercu d'instance editor-only avec chrome minimal et banc d'essai dont les valeurs ne sont jamais exportees. |
