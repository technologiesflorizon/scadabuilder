...
| --- | --- | --- | --- |
| 2026-09-08 | `V2.1.6.0012` | `PENDING` | Tâche 1 du chantier C : `OpenAsync` refuse un projet dont la génération de format dépasse ce que le binaire comprend, avant toute désérialisation. Ferme la perte de données des Fenêtres rapides sur ouverture par un binaire antérieur. |
