...
| --- | --- | --- | --- |
| 2026-07-14 | `V2.1.4.0016` | `10cfa72` | Tranche implementee et couverte automatiquement; cinq echecs historiques restent hors scope et la verification interactive sur projet isole reste a faire. |
