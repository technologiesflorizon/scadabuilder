...
| --- | --- | --- | --- |
| 2026-07-06 | `V2.1.3.0003` | `338670f` | Ajout initial du document, anterieur au standard documentaire; en-tete et historique retro-remplis depuis le commit d'origine. |
