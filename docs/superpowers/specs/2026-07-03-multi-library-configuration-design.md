...
| --- | --- | --- | --- |
| 2026-07-03 | `V2.1.3.0002` | `1924867` | Ajout initial du document, anterieur au standard documentaire; en-tete et historique retro-remplis depuis le commit d'origine. |
