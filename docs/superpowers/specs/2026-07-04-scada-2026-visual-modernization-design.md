...
| --- | --- | --- | --- |
| 2026-07-05 | `V2.1.3.0002` | `966d654` | Ajout initial du document, anterieur au standard documentaire; en-tete et historique retro-remplis depuis le commit d'origine. |
